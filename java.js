...
console.log("Aaron Girard");
console.log("200458198");
...
myImmutableArray("Jane","Mike","Francis");
...
let arr =array.filter(item => !item.startsWith("J"));
...
button.addEventListener("Call Now",function(){
    console.log("call me now at 555-555-5555");
